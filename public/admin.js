    ...
    if (pBody) {
      pBody.innerHTML = data.products.map(p => `
        <tr class="hover:bg-gray-50">
          ...
          <td class="p-3">
            <span class="px-2 py-1 bg-teal-100 text-teal-700 rounded text-xs">${p.category}</span>
          </td>
          <td class="p-3">
    ...
    if (oBody) {
      oBody.innerHTML = data.orders.map(o => `
        <tr class="hover:bg-gray-50">
          ...
          <td class="p-3">
            <span class="px-2 py-1 bg-yellow-100 text-yellow-700 rounded text-xs">${o.status || "Pending"}</span>
          </td>
        </tr>
      `).join("");
    }
